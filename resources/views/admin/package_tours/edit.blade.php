    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.package_tours.update', $packageTour->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            <option value="{{ $packageTour->category->id}}" hidden selected>{{ $packageTour->category->name}}</option>
