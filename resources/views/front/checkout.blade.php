    ...
    <form action="success.html" class="flex flex-col gap-8">
        ...
        <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
            ...
            <div class="flex gap-1 items-center">
                <div class="w-4 h-4">
                <img src="assets/icons/calendar-grey.svg" class="w-4 h-4" alt="icon">
                </div>
        ...
        <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <img src="assets/logos/BCA.svg" class="w-full h-full object-contain object-center" alt="logo">
                </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <img src="assets/icons/bank.svg" class="w-full h-full object-contain object-center" alt="logo">
                </div>
            ...
            <div class="flex items-center gap-2">
                <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                <img src="assets/icons/moneys.svg" class="w-full h-full object-contain object-center" alt="logo">
                </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div id="file-info" class="hidden flex flex-row flex-nowrap gap-3 items-center">
                ...
                <img src="assets/icons/gallery.svg" alt="icon">
                </div>
        ...
        <div class="w-full h-[88px] bg-blue overflow-hidden flex items-center shrink-0 mx-auto rounded-2xl relative">
            <img src="assets/backgrounds/reward-left.png" class="object-contain h-full" alt="rewards">
            ...
            <img src="assets/backgrounds/reward-right.png" class="absolute w-[73px] h-[53px] top-0 right-0" alt="rewards">
        </div>
        </div>
