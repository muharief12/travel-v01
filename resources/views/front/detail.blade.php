...
@section('title', 'detail | travela')
    
@section('content')        
    <div id="image-details" class="px-4 flex flex-col gap-3">
        <div class="w-full h-[345px] flex shrink-0 rounded-xl overflow-hidden">
            <img id="image-thumbnail" src="{{ Storage::url($packageTour->thumbnail)}}" class="w-full h-full object-cover object-center" alt="{{ $packageTour->name }}thumbnail">
        </div>
        <div class="grid grid-cols-4 gap-4 w-fit mx-auto">
            ...
            @foreach ($packageTour->photos as $item)
                <a href="{{ Storage::url($item->photo)}}" class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                    <img src="{{ Storage::url($item->photo)}}" class="w-full h-full object-cover object-center" alt="thumbnail">
                </a>
            @endforeach
            {{-- <a href="assets/thumbnails/nusa-penida2.jpg" class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                <img src="assets/thumbnails/nusa-penida2.jpg" class="w-full h-full object-cover object-center" alt="thumbnail">
            </a>
            <a href="assets/thumbnails/nusa-penida3.jpg" class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                <img src="assets/thumbnails/nusa-penida3.jpg" class="w-full h-full object-cover object-center" alt="thumbnail">
            </a>
            <a href="assets/thumbnails/nusa-penida4.jpg" class="thumbnail-option w-[74px] h-[74px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto opacity-50">
                <img src="assets/thumbnails/nusa-penida4.jpg" class="w-full h-full object-cover object-center" alt="thumbnail">
            </a> --}}
        </div>
    </div>
    ...
    <div class="navigation-bar fixed bottom-0 z-50 max-w-[640px] w-full h-[85px] bg-white rounded-t-[25px] flex items-center justify-between px-6">
        ...
        <a href="{{ route('front.booking', $packageTour)}}" class="p-[16px_24px] rounded-xl bg-blue w-fit text-white hover:bg-[#06C755] transition-all duration-300">Book Now</a>
    </div>
